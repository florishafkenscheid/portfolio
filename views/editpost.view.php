...
<div class="blog">
    <div class="form-div" id="blog-form-div">
        <form method="post" class="form" id="blog-form" action="/blog/updatePost/<?php echo $id ?>">
            ...
            <textarea id="author" name="author"  maxlength="64" spellcheck="false" readonly><?php echo htmlspecialchars($post['author']); ?></textarea>
            <label for="title">Title</label>
            <textarea id="title" name="title"  maxlength="32" spellcheck="false" readonly><?php echo htmlspecialchars($post['title']); ?></textarea>
