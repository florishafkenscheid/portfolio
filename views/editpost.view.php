...
<div class="blog">
    <div class="form-div" id="blog-form-div">
        <form method="post" class="form" id="blog-form" action="/blog/updatePost/<?php echo $id ?>">
            ...
            <textarea id="author" name="author"  maxlength="32" spellcheck="false" readonly disabled><?php echo htmlspecialchars($post['author']); ?></textarea>
            <label for="title">Title</label>
            <textarea id="title" name="title"  maxlength="60" spellcheck="false" readonly disabled><?php echo htmlspecialchars($post['title']); ?></textarea>
